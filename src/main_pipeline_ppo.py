...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_games_per_iteration", type=int, default=2, help="The number of games per iteration.")
    ...
    parser.add_argument('--pm_id', type=str, default='ConvPM_All', help='Planning Model identifier. From: [SPM_base, SPM_QVar, ConvPM_base, ConvPM_QVar, ConvPM_MH, ConvPM_All]')
